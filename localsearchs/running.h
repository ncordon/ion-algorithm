...
public:
   ...
   void setMaxTime(unsigned seconds);
    ...
    void setConvergence(bool print, double best, unsigned int evals){m_generalBest=best;m_generalEval=evals;m_getConvergence=print;}
    
    double getGeneralBest(){return m_generalBest;}
    unsigned int getGeneralEval(){return m_generalEval;}
    
    void setConvergenceFile(FILE *file){convergence_file=file;}
    
    

private:
    unsigned int m_neval;  /**< Current evaluation number */
    unsigned int m_generalEval;
